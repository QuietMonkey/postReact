...
class FormEmployee extends Component {
    ...
    submitForm(e) {
        ...
        const dataPost = {firstname: this.state.firstname,
            lastname: this.state.lastname,
            email: this.state.email}

        const urlPost = "http://campus-bordeaux.ovh:3001/api/quests/employees/"
        axios.post(urlPost, dataPost)
        
            .then(function (response) {
                alert(`Employé ajouté avec l'ID ${response.data}!`);
